  ...
  return (
    <div className="calculatorPage">
      <section className="hero card">
        <div>
          <p className="eyebrow">Smart split for travel & daily groups</p>
          <h1>Split bills with live FX in seconds</h1>
          <p className="muted">Choose a base currency, add mixed-currency payments, and settle fairly with one final result.</p>
        </div>
      </section>
